...
<template>
  <div class="grid grid-cols-[auto_auto_1fr] gap-x-2">
    ...
    <AlertCircle class="place-self-center w-5 h-5 text-red-600" />
    <div style="display:contents">
      <div class="min-w-0 flex items-center gap-2">
        <button @click="expanded = !expanded" class="font-semibold text-red-900 dark:text-red-100 shrink-0 text-left">Conversation Failed</button>
