...
const LLM_BRANDS: BrandDef[] = [
  ...
  { brandKey: 'mistral',     displayName: 'Mistral AI',   apiType: 'mistral',      baseUrl: 'https://api.mistral.ai/v1',               needsRegion: false, needsSubscriptionKey: false, apiKeyUrl: 'https://console.mistral.ai/api-keys',           color: '#f2773d' },
