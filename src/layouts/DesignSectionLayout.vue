...
import { Drama, Route, Target, Microchip, Hammer, Zap, BookOpen, MemoryStick, ShieldCheck, Layers } from 'lucide-vue-next'
...
const menuItems = [
  ...
  { name: 'design.sampleCopies', label: 'Sample Copy', icon: Layers },
