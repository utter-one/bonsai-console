...
const LLM_BRANDS: BrandDef[] = [
  ...
  { brandKey: 'mistral',     displayName: 'Mistral AI',   apiType: 'openai-legacy',     baseUrl: 'https://api.mistral.ai/v1',              needsRegion: false, needsSubscriptionKey: false, apiKeyUrl: 'https://console.mistral.ai/api-keys',           color: '#f2773d' },
  { brandKey: 'groq',        displayName: 'Groq',         apiType: 'openai-legacy',     baseUrl: 'https://api.groq.com/openai/v1',         needsRegion: false, needsSubscriptionKey: false, apiKeyUrl: 'https://console.groq.com/keys',                 color: '#f55036' },
  { brandKey: 'deepseek',    displayName: 'DeepSeek',     apiType: 'openai-legacy',     baseUrl: 'https://api.deepseek.com/v1',            needsRegion: false, needsSubscriptionKey: false, apiKeyUrl: 'https://platform.deepseek.com/api_keys',        color: '#1a73e8' },
  { brandKey: 'xai',         displayName: 'xAI (Grok)',   apiType: 'openai-legacy',     baseUrl: 'https://api.x.ai/v1',                    needsRegion: false, needsSubscriptionKey: false, apiKeyUrl: 'https://console.x.ai',                         color: '#374151' },
  { brandKey: 'openrouter',  displayName: 'OpenRouter',   apiType: 'openai-legacy',     baseUrl: 'https://openrouter.ai/api/v1',           needsRegion: false, needsSubscriptionKey: false, apiKeyUrl: 'https://openrouter.ai/settings/keys',           color: '#8b5cf6' },
