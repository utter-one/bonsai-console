    ...
    children: [
      ...
      // Administration Section
      {
        ...
        children: [
          ...
          { path: 'monitoring/alerts', name: 'administration.monitoring.alerts', component: () => import('@/views/administration/monitoring/AlertsView.vue') },
          { path: 'monitoring/alerts/:alertId', name: 'administration.monitoring.alertDetail', component: () => import('@/views/administration/monitoring/AlertDetailView.vue') },
          ...
          { path: 'monitoring/config', name: 'administration.monitoring.config', component: () => import('@/views/administration/monitoring/MonitoringConfigView.vue') },
        ],
      },
    ],
  },
